            ...
            <div>
                ...
                <div>
                    <Link to="/taManagement/submitted">
                        <button style={{float:'right' }} className="button-style">Submit</button>
                    </Link>
                 </div>
            </div>
        </div>
...
const Wishlist = () => {
    return (
        <div>
            <Routes>
            <Route path="/taManagement/wishlist" element ={<SelectTaWishList />}> </Route>
            <Route
            path="/taManagement/submitted"
            element={<Success btn1="BACK TO OPTIONS" btn2="GO BACK TO DASHBOARD"/>}
            ></Route>
            </Routes>
        </div>
